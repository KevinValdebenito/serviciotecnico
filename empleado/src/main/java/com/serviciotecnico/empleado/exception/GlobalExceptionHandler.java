...
import com.serviciotecnico.empleado.dto.ErrorDetails;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleGlobalException(Exception ex, WebRequest request) {
        ErrorDetails errorDetails = new ErrorDetails("INTERNAL_SERVER_ERROR", "An unexpected error occurred: " + ex.getMessage());
        ApiResponse<?> response  = new ApiResponse<>(false,errorDetails);
